...
public class TesteProduto {
	...
	public void testCreateObject() {
		...
		Produto p1 = new Produto(1L, "Liquidificador Phillips", "Liquidificador Phillips 3v", cat, new BigDecimal(130.00),"Phillips", null);
	...
	public void testCompareObjects() {
		Categoria cat = new Categoria(1L, "Cozinha", null);
		Produto p1 = new Produto(1L, "Liquidificador Phillips", "Liquidificador Phillips 3v", cat, new BigDecimal(130.00),"Phillips", null);
		Produto p2 = new Produto(1L, "Palha de Aço Bombril", "Bombril", cat, new BigDecimal(1.30), "Bombril", null);
...
/*
	...
	public void testPrintObject() {
		Categoria cat = new Categoria(1L, "Cozinha", null);
		Produto p1 = new Produto(1L, "Liquidificador Phillips", "Liquidificador Phillips 3v", cat, new BigDecimal(130.00),"Phillips", null);
		assertEquals(p1.toString(), "Produto [id=1, nome=Liquidificador Phillips, descricao=Liquidificador Phillips 3v, categoria=Categoria [id=1, descricao=Cozinha], preco=130, fabricante=Phillips");
